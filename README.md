...
Canonical source: [`fireviewer/fireviewer-geolocation`](https://github.com/fireviewer/fireviewer-geolocation). Technical stewardship: FIRE-VIEWER. Repository access: private.
